...
namespace DeepinfraLlamaApi
{
    internal class DeepinfraRequest
    {
        ...
        internal double RepetitionPenalty { get; set; } = 1;
        ...
        internal int NumResponses { get; set; } = 1;
        ...
        internal double PresencePenalty { get; set; } = 0;
        ...
        internal double FrequencyPenalty { get; set; } = 0;
